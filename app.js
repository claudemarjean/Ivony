...
async function getUserProfile(userId) {
    ...
    try {
        const { data, error } = await supabaseClient
            ...
            .single();
        if (error) {
            console.log('Erreur lors de la requête profiles:', error);
            throw error;
        }
